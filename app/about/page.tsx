    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 py-16">
          <span className="text-accent font-display text-lg md:text-xl italic mb-4 block">
      ...
      <section className="py-4 bg-secondary/80 overflow-hidden">
      ...
      <section className="container mx-auto px-4 lg:px-8 py-16 lg:py-24 border-t border-border">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              {/* Info */}
              <div className="p-4">
                <h3 className="font-display font-bold text-sm md:text-base uppercase group-hover:text-primary transition-colors">
                  {member.name}
                </h3>
